...
#handle PhpDocumentor2's phpdoc.php as PhpDocumentor's phpdoc
link "#{node['phpdoc']['prefix']}/phpdoc.php" do
    to "#{node['phpdoc']['prefix']}/phpdoc"
    only_if do ::File.file?("#{node['phpdoc']['prefix']}/phpdoc.php"); end
end